          ...
          <div className="flex flex-wrap justify-center gap-1.5 mt-4 min-h-[28px]">
            {member.skills.map((skill) => (
              <span
                ...
                style={{ backgroundColor: "var(--card)", color: "var(--gray-550)", border: "1px solid var(--gray-100)" }}
              ...
              >
                <span
                  ...
                  style={{
                    ...
                    backgroundColor: i === active ? "var(--foreground)" : "var(--gray-100)",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          <div className="lg:pt-8">
            ...
            >
              ...
              you can't get to
              <br />
              <span style={{ color: "var(--gray-450)" }}>anymore.</span>
            </h1>
            <p
            ...
            <div className="flex flex-wrap items-center gap-4 mt-8 sm:mt-10">
              <a
                ...
                style={{ backgroundColor: "var(--foreground)", color: "var(--background)", border: "1px solid var(--muted-foreground)" }}
              >
                Start a project
              ...
              <a
                ...
                style={{ backgroundColor: "var(--card)", color: "var(--foreground)", borderRadius: "0px", borderColor: "var(--gray-100)" }}
              >
                Our approach
              </a>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-border/50 flex flex-wrap gap-6 sm:gap-8" data-testid="hero-proof">
              <div>
                ...
                <p className="text-xs font-mono mt-1" style={{ color: "var(--muted-foreground)" }}>Years serving<br />founders</p>
              </div>
              <div>
                <p className="text-2xl sm:text-3xl font-semibold tracking-tight text-foreground">57%</p>
                <p className="text-xs font-mono mt-1" style={{ color: "var(--muted-foreground)" }}>Operating<br />profitability</p>
              </div>
              <div>
                <p className="text-2xl sm:text-3xl font-semibold tracking-tight text-foreground">0€</p>
                <p className="text-xs font-mono mt-1" style={{ color: "var(--muted-foreground)" }}>External debt<br />raised, ever</p>
              </div>
            </div>
          </div>
          ...
          <div key={set} className="flex items-center gap-12 sm:gap-16 shrink-0">
            {words.map((word) => (
              <span
                ...
                style={{ color: word.bold ? "var(--muted-foreground)" : "var(--gray-450)" }}
              >
                {word.text}
              </span>
            ))}
...
function PainRecognition() {
  ...
  return (
    <section aria-label="The problem we solve" className="px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24" style={{ backgroundColor: "var(--foreground)" }}>
      <div className="max-w-[1200px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            to manage its{" "}
            <span style={{ color: "var(--gray-350)" }}>back-office.</span>
          </h2>
          <ul className="space-y-0 list-none m-0 p-0">
            {pains.map((pain, i) => (
              ...
              >
                <span className="text-xs font-mono pt-0.5" style={{ color: "var(--muted-foreground)" }}>{pain.num}</span>
                <p className="text-base leading-relaxed" style={{ color: "var(--white-alpha-85)" }}>
                  <strong className="font-semibold" style={{ color: "var(--background)" }}>{pain.lead}</strong>
                  {pain.rest}
                </p>
              </li>
            ))}
    ...
    <section id="services" aria-labelledby="services-heading" className="px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36">
      <div className="max-w-[1200px] mx-auto">
        <header className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12 sm:mb-16">
          <div>
            <p className="text-xs uppercase tracking-[0.2em] font-medium mb-3" style={{ color: "var(--muted-foreground)" }} aria-hidden="true">What we do</p>
            <h2
              id="services-heading"
          ...
          <a href="#contact" className="text-sm font-medium flex items-center gap-1.5 transition-opacity duration-150" style={{ color: "var(--muted-foreground)" }} data-testid="link-discuss-project">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-px rounded-lg overflow-hidden border border-border/50">
          {services.map((service) => (
            ...
            >
              <span className="text-xs font-mono font-medium" style={{ color: "var(--gray-450)" }}>{service.num}</span>
              <h3 className="text-lg sm:text-xl font-semibold text-foreground mt-3">{service.title}</h3>
              <p className="text-sm leading-relaxed mt-2" style={{ color: "var(--muted-foreground)" }}>{service.description}</p>
              <ul className="mt-4 space-y-2 list-none m-0 p-0">
                {service.outcomes.map((outcome) => (
                  <li key={outcome} className="text-xs font-mono pl-4 relative" style={{ color: "var(--muted-foreground)" }}>
...
function Stats() {
  return (
    <section aria-label="Key metrics" className="px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
      <div className="max-w-[1200px] mx-auto">
        <div className="rounded-lg p-8 sm:p-12 lg:p-16" style={{ backgroundColor: "var(--foreground)" }}>
          <p className="text-xs uppercase tracking-[0.15em] font-medium mb-10" style={{ color: "var(--gray-350)" }} data-testid="text-stats-label">
            {siteConfig.name} — by the numbers
          </p>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
            {stats.map((stat) => (
              <div key={stat.label} className="text-left" data-testid={`stat-${stat.value}`}>
                <p className="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight" style={{ color: "var(--background)" }}>
    ...
    <section id="work" aria-labelledby="work-heading" className="px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36 border-t border-border/50">
      <div className="max-w-[1200px] mx-auto">
        <header className="mb-12 sm:mb-16">
          <p className="text-xs uppercase tracking-[0.2em] font-medium mb-3" style={{ color: "var(--muted-foreground)" }} aria-hidden="true">Track record</p>
          <h2
            id="work-heading"
            className="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight text-foreground"
          ...
          {projects.map((project, i) => (
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-[160px_1fr_auto] gap-3 sm:gap-8 items-start sm:items-center">
                <span className="text-xs font-mono uppercase tracking-wider" style={{ color: "var(--muted-foreground)" }}>{project.category}</span>
                <div>
                  <h3 className="text-base font-semibold text-foreground">{project.title}</h3>
                  <p className="text-sm mt-1" style={{ color: "var(--muted-foreground)" }}>{project.description}</p>
                </div>
                <div className="flex items-center gap-3 flex-shrink-0">
                  <span className="text-xs font-mono" style={{ color: "var(--gray-450)" }}>{project.year}</span>
                  <span
                    className="text-xs font-medium px-2 py-1 rounded"
                    style={{ backgroundColor: "var(--accent-yellow)", color: "var(--foreground)" }}
...
function About() {
  ...
  return (
    <section id="approach" aria-labelledby="about-heading" className="px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36" style={{ backgroundColor: "var(--card)" }}>
      <div className="max-w-[1200px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          <div>
            <p className="text-xs uppercase tracking-[0.2em] font-medium mb-3" style={{ color: "var(--muted-foreground)" }} aria-hidden="true">Our approach</p>
            <h2
              id="about-heading"
            ...
            >
              ...
              who refuse to keep{" "}
              <span style={{ color: "var(--gray-450)" }}>drowning.</span>
            </h2>
            <p className="text-sm sm:text-base leading-relaxed mt-6" style={{ color: "var(--muted-foreground)" }}>
            ...
            <p className="text-sm sm:text-base leading-relaxed mt-4" style={{ color: "var(--muted-foreground)" }}>
          ...
          <div>
            <ul className="list-none m-0 p-0 border-t" style={{ borderColor: "var(--gray-225)" }}>
              {pillars.map((pillar) => (
                <li
                  key={pillar.name}
                  className="grid grid-cols-[20px_1fr] gap-5 items-start py-5 border-b"
                  style={{ borderColor: "var(--gray-225)" }}
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm mt-1" style={{ color: "var(--muted-foreground)" }}>{pillar.desc}</p>
                  </div>
                </li>
              ))}
            </ul>
    ...
    <section id="team" aria-labelledby="team-heading" className="px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36 border-t border-border/50">
      <div className="max-w-[1200px] mx-auto">
        <header className="mb-12 sm:mb-16 max-w-2xl">
          <p className="text-xs uppercase tracking-[0.2em] font-medium mb-3" style={{ color: "var(--muted-foreground)" }} aria-hidden="true">Who we are</p>
          <h2
            id="team-heading"
            className="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight text-foreground"
          ...
          <p className="text-sm sm:text-base mt-4 leading-relaxed" style={{ color: "var(--muted-foreground)" }}>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  <p className="text-sm font-medium mt-0.5" style={{ color: "var(--gray-450)" }} data-testid={`text-team-role-${firstName}`}>
                    {member.role}
                  </p>
                  <p className="text-sm leading-relaxed mt-3" style={{ color: "var(--muted-foreground)" }} data-testid={`text-team-bio-${firstName}`}>
                    {member.bio}
                  </p>
...
function Story() {
  return (
    <section id="story" aria-labelledby="story-heading" className="px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36" style={{ backgroundColor: "var(--card)" }}>
      <div className="max-w-[1200px] mx-auto">
        <header className="mb-12 sm:mb-16 max-w-2xl">
          <p className="text-xs uppercase tracking-[0.2em] font-medium mb-3" style={{ color: "var(--muted-foreground)" }} aria-hidden="true">Our story</p>
          <h2
            id="story-heading"
            className="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight text-foreground leading-tight"
        ...
        <div className="mt-12 sm:mt-16 p-8 sm:p-12 rounded-lg" style={{ backgroundColor: "var(--foreground)" }}>
          <p className="text-lg sm:text-xl lg:text-2xl font-semibold leading-snug tracking-tight" style={{ color: "var(--background)" }} data-testid="text-story-promise">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            <span className="text-xs font-medium" style={{ color: "var(--gray-350)" }}>
              Operational depth — Anne, Cécile, {siteConfig.shortName}, law firms
            </span>
            <span className="text-xs" style={{ color: "var(--gray-350)" }}>·</span>
            <span className="text-xs font-medium" style={{ color: "var(--gray-350)" }}>
          ...
          <footer className="mt-6 sm:mt-8">
            <div className="flex items-center justify-center gap-3">
              <div
                ...
                style={{ backgroundColor: "var(--gray-300)", color: "var(--foreground)" }}
                aria-hidden="true"
              >
...
function Faq() {
  return (
    <section id="faq" aria-labelledby="faq-heading" className="px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36 border-t border-border/50">
      <div className="max-w-[1200px] mx-auto">
        <header className="mb-12 sm:mb-16 max-w-2xl">
          <p className="text-xs uppercase tracking-[0.2em] font-medium mb-3" style={{ color: "var(--muted-foreground)" }} aria-hidden="true">FAQ</p>
          <h2
            id="faq-heading"
            className="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight text-foreground"
        ...
        <div className="border border-border/50 rounded-lg overflow-hidden">
          {resolvedFaq.map((item, i) => (
            ...
            >
              ...
              <p className="px-6 sm:px-8 pb-6 sm:pb-7 -mt-1 text-sm leading-relaxed max-w-3xl" style={{ color: "var(--muted-foreground)" }} data-testid={`text-faq-answer-${i}`}>
                {item.answer}
              </p>
            </details>
          ))}
...
function Contact() {
  ...
  return (
    <section id="contact" aria-labelledby="contact-heading" className="px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36" style={{ backgroundColor: "var(--card)" }}>
      <div className="max-w-[1200px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          <div>
            <p className="text-xs uppercase tracking-[0.2em] font-medium mb-3" style={{ color: "var(--muted-foreground)" }} aria-hidden="true">Contact</p>
            <h2
              id="contact-heading"
              className="text-2xl sm:text-3xl lg:text-4xl font-semibold tracking-tight text-foreground leading-tight"
            ...
            >
              ...
              <span style={{ color: "var(--gray-450)" }}>off your plate.</span>
            </h2>
            <p className="text-sm sm:text-base mt-4 leading-relaxed" style={{ color: "var(--muted-foreground)" }}>
            ...
            <div className="mt-8 space-y-4">
              <div>
                <span className="text-xs font-mono uppercase tracking-wider" style={{ color: "var(--muted-foreground)" }}>Email</span>
                <p className="text-sm font-medium text-foreground mt-0.5">
                  <a href={`mailto:${siteConfig.email}`} className="underline" style={{ textDecorationColor: "var(--gray-100)" }} data-testid="link-contact-email">{siteConfig.email}</a>
                </p>
              </div>
              <div>
                <span className="text-xs font-mono uppercase tracking-wider" style={{ color: "var(--muted-foreground)" }}>Based in</span>
          ...
          <div>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                />
                {errors.name && <p id="contact-name-error" className="text-xs mt-1" style={{ color: "var(--red-600)" }} data-testid="text-error-name">{errors.name}</p>}
              </div>
              <div>
                ...
                />
                {errors.email && <p id="contact-email-error" className="text-xs mt-1" style={{ color: "var(--red-600)" }} data-testid="text-error-email">{errors.email}</p>}
              </div>
              <div>
    ...
    <footer className="px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 pb-8 sm:pb-10 border-t border-border/50" role="contentinfo">
      <div className="max-w-[1200px] mx-auto">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 list-none m-0 p-0">
              <li className="flex items-center gap-2">
                <Mail className="w-3 h-3 flex-shrink-0" style={{ color: "var(--gray-450)" }} aria-hidden="true" />
                <a
              ...
              <li className="flex items-center gap-2">
                <MapPin className="w-3 h-3 flex-shrink-0" style={{ color: "var(--gray-450)" }} aria-hidden="true" />
                <span className="text-xs" style={{ color: "var(--muted-foreground)" }} data-testid="text-footer-locations">{siteConfig.locations}</span>
              </li>
            </ul>
              ...
              {people.map((person) => {
                ...
                return (
                  <li key={person.name}>
                    ...
                    >
                      <SiLinkedin className="w-3 h-3 flex-shrink-0" style={{ color: "var(--gray-450)" }} aria-hidden="true" />
                      {person.name}
                    </a>
                    <p className="text-[11px] mt-0.5 pl-[18px]" style={{ color: "var(--gray-450)" }}>{person.role}</p>
                  </li>
                );
              })}
            </ul>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {companies.map((company) => (
                <div key={company.siren}>
                  ...
                  <p className="text-[11px] mt-0.5" style={{ color: "var(--gray-450)" }}>
        ...
        <div className="mt-10 sm:mt-12 pt-6 border-t border-border/50 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <p className="text-[11px]" style={{ color: "var(--gray-450)" }}>
          ...
          <p className="text-[10px] hidden sm:block" style={{ color: "var(--gray-250)" }} data-testid="text-footer-version">
          ...
          <p className="text-[11px]" style={{ color: "var(--gray-450)" }} data-testid="text-footer-address">
