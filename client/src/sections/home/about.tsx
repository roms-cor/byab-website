    ...
    <section id="approach" aria-labelledby="about-heading" className="px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36 bg-card">
      <div className="max-w-container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          <div>
            <p className="text-xs uppercase tracking-eyebrow font-medium mb-3 text-muted-foreground" aria-hidden="true">Our approach</p>
            <h2
              id="about-heading"
            ...
            >
              ...
              who refuse to keep{" "}
              <span className="text-gray-450">drowning.</span>
            </h2>
